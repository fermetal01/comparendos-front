...
export class ServicioComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.servicioService
      ...
      .subscribe(
        (res: HttpResponse<IServicio[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInServicios(): void {
    this.eventSubscriber = this.eventManager.subscribe('servicioListModification', () => this.loadPage());
  }

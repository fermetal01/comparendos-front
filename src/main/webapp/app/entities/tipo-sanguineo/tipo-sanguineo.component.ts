...
export class TipoSanguineoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.tipoSanguineoService
      ...
      .subscribe(
        (res: HttpResponse<ITipoSanguineo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ITipoSanguineo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
